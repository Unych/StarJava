    ...
    void gameplay() {
        ...
        while(playerOne.getNumber() != hiddenNum || playerTwo.getNumber()  != hiddenNum) {
            ...
            if (playerOne.getNumber() < hiddenNum) {
                ...
                System.out.println(playerOne.getName() + " Вы победили! число " + playerOne.getNumber() + " = " + hiddenNum);
                break;
            }
            ...
            if (playerTwo.getNumber() < hiddenNum) {
                ...
                System.out.println(playerTwo.getName() + " Вы победили! число " + playerTwo.getNumber() + " = " + hiddenNum);
                break;
            }
        }
    }
